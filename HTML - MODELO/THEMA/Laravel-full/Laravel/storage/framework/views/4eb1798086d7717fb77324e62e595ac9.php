    ...
    <?php $__env->startPush('css'); ?>
        <link rel="stylesheet" href="<?php echo e(URL::asset('build/libs/prismjs/themes/prism-okaidia.css')); ?>">
    <?php $__env->stopPush(); ?>
            ...
            <div class="fixed inset-x-0 bottom-12 2xl:w-20 shrink-0 xl:relative z-[20] text-center xl:bottom-auto">
                <div
                    ...
                    <div class="flex items-center h-full p-2 2xl:p-4 xl:flex-col">
                        <a href="#!" class="hidden xl:block"><img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>"
                        ...
                        <ul class="flex items-center gap-2 my-auto text-center xl:mb-0 xl:mt-auto xl:pt-4 xl:flex-col">
                            <li>
                                <a href="<?php echo e(url('pages-account-settings')); ?>"
                            ...
                            <li class="hidden md:block">
                                <div class="relative dropdown">
                                    <a href="#!" type="button"
                                        ...
                                        <img src="<?php echo e(URL::asset('build/images/users/avatar-1.png')); ?>" alt=""
                                    ...
                                    <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                        ...
                                        <li>
                                            <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                href="<?php echo e(url('auth-login-basic')); ?>">Logout</a>
                                        </li>
                                        <li>
                                            <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                href="<?php echo e(url('auth-login-cover')); ?>">Switch Account</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                    ...
                                    <ul class="flex flex-col gap-1" id="chatList">
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/user-1.jpg')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/user-2.jpg')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/user-3.jpg')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-8.png')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-10.png')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600">
                                                    <img src="<?php echo e(URL::asset('build/images/users/user-4.jpg')); ?>"
                                                        alt="" class="rounded-full h-9">
                                                    <span
                                                        class="absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500"></span>
                                                </div>
                                ...
                                <div data-simplebar class="max-h-[calc(100vh_-_380px)] xl:max-h-[calc(100vh_-_300px)]">
                                    <div class="flex flex-col gap-3">
                                        ...
                                        <a href="#!"
                                            ...
                                            <div
                                                class="flex items-center justify-center text-sm font-semibold rounded-md size-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" alt=""
                                                    class="h-6">
                                            </div>
                                            <div class="grow">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="#!" data-drawer-target="drawerEnd"
                                ...
                                <div class="size-10 rounded-full bg-slate-100 dark:bg-zink-600">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-7.png')); ?>" alt=""
                    ...
                    <div data-simplebar class="h-[calc(100vh_-_320px)] xl:h-[calc(100vh_-_250px)]">
                        <div
                            ...
                            <div
                                ...
                                <img src="<?php echo e(URL::asset('build/images/users/user-2.jpg')); ?>" alt=""
...
@import 'tailwindcss/utilities';</code></pre>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script src="<?php echo e(URL::asset('build/js/pages/apps-chat.init.js')); ?>"></script>
        <!-- App js -->
        <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
    <?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\resources\views/apps-chat.blade.php ENDPATH**/ ?>