            ...
            <div
                ...
                <div
                    ...
                    <a href="<?php echo e(url('index')); ?>">
                        <span class="hidden">
                            <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" alt="" class="h-6 mx-auto">
                        </span>
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            <?php switch(Session::get('lang')):
                                case ('ru'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/ru.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('it'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/it.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('sp'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/es.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('ch'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/china.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('fr'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/fr.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('gr'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/de.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('ar'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/ae.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php case ('jp'): ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/jp.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                                <?php break; ?>

                                <?php default: ?>
                                    <img src="<?php echo e(URL::asset('build/images/flags/20/us.svg')); ?>" alt=""
                                        id="header-lang-img" class="h-5 rounded-sm">
                            <?php endswitch; ?>
                        </button>
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[10rem] flex flex-col gap-4 dark:bg-zink-600"
                            ...
                            <a href="<?php echo e(url('index/en')); ?>" class="flex items-center gap-3 group/items language" data-lang="en"
                                title="English">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/us.svg')); ?>" alt=""
                            ...
                            <a href="<?php echo e(url('index/sp')); ?>" class="flex items-center gap-3 group/items language" data-lang="sp"
                                title="Spanish">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/es.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/gr')); ?>" class="flex items-center gap-3 group/items language" data-lang="gr"
                                title="German">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/de.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/fr')); ?>" class="flex items-center gap-3 group/items language" data-lang="fr"
                                title="French">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/fr.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/jp')); ?>" class="flex items-center gap-3 group/items language" data-lang="jp"
                                title="Japanese">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/jp.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/ch')); ?>" class="flex items-center gap-3 group/items language" data-lang="ch"
                                title="Chinese">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/china.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/it')); ?>" class="flex items-center gap-3 group/items language" data-lang="it"
                                title="Italian">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/it.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/ru')); ?>" class="flex items-center gap-3 group/items language" data-lang="ru"
                                title="Russian">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/ru.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                            ...
                            <a href="<?php echo e(url('index/ar')); ?>" class="flex items-center gap-3 group/items language" data-lang="ar"
                                title="Arabic">
                                <img src="<?php echo e(URL::asset('build/images/flags/20/ae.svg')); ?>" alt=""
                                    class="object-cover h-4 rounded-full">
                                <h6
                                ...
                                <div class="flex flex-col gap-1" id="notification-list">
                                    <a href="#!"
                                        ...
                                        <div class="w-10 h-10 rounded-md shrink-0 bg-slate-100">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.png')); ?>"
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="w-10 h-10 bg-yellow-100 rounded-md shrink-0">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.png')); ?>"
                                                alt="" class="rounded-md">
                                        </div>
                                        <div class="grow">
                                    ...
                                    <a href="#!"
                                        ...
                                        <div class="relative shrink-0">
                                            <div class="w-10 h-10 bg-pink-100 rounded-md">
                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-7.png')); ?>"
                                                    alt="" class="rounded-md">
                                            </div>
                                ...
                                <ul class="pt-2 mt-2 border-t border-slate-200 dark:border-zink-500">
                                    <li>
                                        <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                            href="<?php echo e(route('teams.show', Auth::user()->currentTeam->id)); ?>"><i
                                                data-lucide="user-2"
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', Laravel\Jetstream\Jetstream::newTeamModel())): ?>
                                        <li>
                                            <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                                href="<?php echo e(route('teams.create')); ?>"><i data-lucide="user-2"
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                            ...
                            <a href="#!" class="flex gap-3 mb-3">
                                    ...
                                    <div class="relative inline-block shrink-0">
                                        <div class="rounded bg-slate-100 dark:bg-zink-500">
                                            <img src="<?php echo e(Auth::user()->profile_photo_url); ?>"
                                                alt="<?php echo e(Auth::user()->name); ?>" class="w-12 h-12 rounded">
                                        </div>
                                        <span
                                ...
                                <?php endif; ?>
                                <div>
                                    <h6 class="mb-1 text-15"><?php echo e(Auth::user()->name); ?></h6>
                            ...
                            <ul>
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="<?php echo e(route('profile.show')); ?>"><i data-lucide="user-2"
                                            class="inline-block size-4 ltr:mr-2 rtl:ml-2"></i> Profile</a>
                                </li>
                                <?php if(Laravel\Jetstream\Jetstream::hasApiFeatures()): ?>
                                    <li>
                                        <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                            href="<?php echo e(route('api-tokens.index')); ?>"><i data-lucide="key-round"
                                                class="inline-block size-4 ltr:mr-2 rtl:ml-2"></i> API Tokens</a>
                                    </li>
                                <?php endif; ?>
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="<?php echo e(url('apps-mailbox')); ?>"><i data-lucide="mail"
                                ...
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="<?php echo e(url('apps-chat')); ?>"><i data-lucide="messages-square"
...
<div id="cartSidePenal" drawer-end
    ...
    <div>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex gap-2 product">
                    <div
                        ...
                        <img src="<?php echo e(URL::asset('build/images/product/img-01.png')); ?>" alt=""
                            class="h-8">
                    </div>
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="<?php echo e(URL::asset('build/images/product/img-03.png')); ?>" alt=""
                            class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">
                ...
                <div class="flex gap-2 product">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500">
                        <img src="<?php echo e(URL::asset('build/images/product/img-09.png')); ?>" alt=""
                            class="h-8">
                    </div>
                    <div class="overflow-hidden grow">
                        <div class="ltr:float-right rtl:float-left">
        ...
        <div class="p-4 border-t border-slate-200 dark:border-zink-500">
            ...
            <div class="flex items-center justify-between gap-3">
                <a href="<?php echo e(url('apps-ecommerce-product-grid')); ?>"
                    ...
                    Shopping</a>
                <a href="<?php echo e(url('apps-ecommerce-checkout')); ?>"
...
<?php /**PATH D:\Laravel\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>