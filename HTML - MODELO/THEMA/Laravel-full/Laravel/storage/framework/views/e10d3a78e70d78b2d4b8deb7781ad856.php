...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['title' => 'Ecommerce','pagetitle' => 'Dashboards']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Ecommerce','pagetitle' => 'Dashboards']); ?>
            ...
            <div class="relative card-body">
                <div class="grid items-center grid-cols-12">
                    ...
                    <div class="hidden col-span-12 2xl:col-span-3 lg:col-span-2 lg:col-start-11 2xl:col-start-10 lg:block">
                        <img src="<?php echo e(URL::asset('build/images/dashboard.png')); ?>" alt=""
                    ...
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100365</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Marie Prohaska</td>
                                        ...
                                        <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                            ...
                                            <li>
                                                <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                    href="<?php echo e(url('apps-ecommerce-order-overview')); ?>"><i data-lucide="eye"
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100366</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Jaqueline Hammes</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100367</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Marlene Hirthe</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100368</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Reagan Larson</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100369</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Glennie Langosh</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100370</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Rickie Cremin</td>
                            ...
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <a href="<?php echo e(url('apps-ecommerce-order-overview')); ?>">#TWT5015100371</a>
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    Domenic Tromp</td>
                ...
                <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.png')); ?>" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-3.png')); ?>" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-4.png')); ?>" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="size-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.png')); ?>" alt="" class="size-8 rounded-full">
                        </div>
                        <div class="grow">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/product/img-02.png')); ?>" alt="" class="h-6">
                        </div>
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/product/img-03.png')); ?>" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/product/img-04.png')); ?>" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/product/img-05.png')); ?>" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="<?php echo e(URL::asset('build/images/product/img-06.png')); ?>" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/dashboards-ecommerce.init.js')); ?>"></script>

    <!-- App js -->
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\resources\views/index.blade.php ENDPATH**/ ?>