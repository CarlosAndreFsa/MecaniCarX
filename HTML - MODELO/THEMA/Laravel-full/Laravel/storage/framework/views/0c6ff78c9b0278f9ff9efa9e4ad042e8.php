    ...
    <body
        ...
        <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
            <div class="!px-10 !py-12 card-body">
                <a href="index">
                    <img src="<?php echo e(URL::asset('build/images/logo-light.png')); ?>" alt="" class="hidden h-6 mx-auto dark:block">
                    <img src="<?php echo e(URL::asset('build/images/logo-dark.png')); ?>" alt="" class="block h-6 mx-auto dark:hidden">
                </a>

                <div class="mt-10">
                    <img src="<?php echo e(URL::asset('build/images/auth/error-404.png')); ?>" alt="" class="h-64 mx-auto">
                </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\resources\views/errors/404.blade.php ENDPATH**/ ?>