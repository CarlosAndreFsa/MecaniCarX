                ...
                <form action="{{ route('vehicles.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="plate" id="plate" value="{{ old('plate') }}" placeholder="Ex: ABC-1234" class="w-full uppercase rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="model" id="model" value="{{ old('model') }}" placeholder="Ex: Honda Civic X" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="year" id="year" value="{{ old('year') }}" placeholder="Ex: 2022" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="color" id="color" value="{{ old('color') }}" placeholder="Ex: Prata" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm">
                    ...
                    <div class="flex items-center justify-end mt-8 gap-4">
                        ...
                        <button type="submit" class="px-6 py-2 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition shadow-lg shadow-orange-600/30 hover:scale-105">Salvar Veículo</button>
                    </div>
                </form>
            </div>
        </div>
