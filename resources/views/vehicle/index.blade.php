    ...
    <x-slot name="header">
        <div class="flex justify-between items-center px-4 md:px-8">
            ...
            <a href="{{ route('vehicles.create') }}"
                class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-6 rounded-xl text-sm transition-all shadow-lg shadow-orange-600/20 hover:scale-105">
                {{ __('+ Novo Veículo') }}
            </a>
        </div>
    </x-slot>
        ...
        <div class="px-4 md:px-8 space-y-4">
            ...
            <div
                ...
                <form action="{{ route('vehicles.index') }}" method="GET" class="flex w-full gap-4">
                    ...
                    <button type="submit"
                        class="bg-gray-200 dark:bg-gray-700 hover:bg-orange-600 hover:text-white dark:hover:bg-orange-600 text-gray-800 dark:text-gray-200 font-bold py-2 px-8 rounded-xl transition-all border border-gray-200 dark:border-gray-600 shadow-sm">
                        Filtrar
                    </button>
                </form>
            </div>
            ...
            {{-- Tabela Full Width --}}
            <div
                class="w-full bg-white dark:bg-gray-800 shadow-xl rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <table class="w-full text-left">
                        <thead class="bg-gray-50/50 dark:bg-gray-900/30 border-b dark:border-gray-700">
                            <tr>
                                <th
                                <th
                                    class="p-4 text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest">
                                    Marca / Modelo
                                </th>
                                <th
                                    class="p-4 text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest">
                                ...
                                <th
                                    ...
                                    Cliente</th>
                                <th
                                    class="p-4 text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest text-center">
                                    Ações</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($vehicles as $vehicle)
                                <tr class="hover:bg-orange-50/20 dark:hover:bg-orange-900/10 transition-colors">
                                    ...
                                    <td class="p-4">
                                        ...
                                        <div class="text-xs text-gray-500">{{ $vehicle->brand->name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="p-4">
                                        <span
                                            class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-md font-mono font-bold border dark:border-gray-600 shadow-sm uppercase">
                                            {{ $vehicle->plate }}
                                        </span>
                                    </td>
                                    <td class="p-4">
                                        <span
                                            class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-md font-mono font-bold border dark:border-gray-600 shadow-sm uppercase">
                                            {{ $vehicle->customer->name_fantasy ?? 'Sem Cliente' }}
                                        </span>
                                    </td>
                                    <td class="p-4">
                                        <div class="flex justify-center gap-2">
                                            <a href="{{ route('vehicles.show', $vehicle->id) }}"
                                                class="p-2 text-gray-400 hover:text-emerald-500 transition-colors"><svg
                                            ...
                                            <a href="{{ route('vehicles.edit', $vehicle->id) }}"
                                                class="p-2 text-gray-400 hover:text-blue-500 transition-colors"><svg
                                                    class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="p-10 text-center text-gray-500 italic">Nenhum veículo
                                        cadastrado.</td>
                                </tr>
                            @endforelse
                        </tbody>
