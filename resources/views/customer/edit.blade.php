<x-app-layout>
    <form method="POST" action="{{ route('customer.update', $customer) }}" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="name_fantasy"
                        class="w-full border rounded px-3 py-2 text-sm"
                        value="{{ old('name_fantasy', $customer->name_fantasy) }}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="cpf_cnpj"
                        class="w-full border rounded px-3 py-2 text-sm"
                        value="{{ old('cpf_cnpj', $customer->cpf_cnpj) }}">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="address[zip_code]"
                        class="w-full border rounded px-3 py-2 text-sm"
                        value="{{ old('address.zip_code', $customer->address->zip_code ?? '') }}">
                </div>
